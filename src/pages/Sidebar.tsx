...
export default function Sidebar({ toggleSideBar, sidebarVisible }: Props) {
  return (
    <div
      className={` z-50 fixed bg-[#04177f] flex flex-col justify-between w-[188px] h-[600px] rounded-tr-[15px] rounded-br-[15px] md:w-[290px] lg:w-[320px] lg:h-[100vh] lg:rounded-tr-[25px] lg:rounded-br-[25px] ${
